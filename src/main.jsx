...
function MyFirstApp(){
  ...
  function clicked(){
    // setToggle(!toggle);
    setBg(prev => prev==="yellow" ? "magenta" : "yellow");
  }
...
function Timer(){
  ...
  // },[])
  const names = [
    "Haseeb", "Shoaib", "Charlie", "Diana", "Edward", "Fatima", "George", "Hannah", "Ivan", "Julia", "Kevin", "Laura", "Michael", "Nora", "Oscar", "Priya", "Quinn", "Haseeb", "Samuel", "Tina", "Usman", "Victoria", "William", "Xena", "Yusuf", "Zara", "Ahmed", "Bella", "Carlos", "Daisy","Shoaib"
  ]
